...
import 'package:khidmh/common/widgets/demo_reset_dialog_widget.dart';
import 'package:khidmh/feature/booking/widget/booking_ignored_bottom_sheet.dart';
  ...
  static Future<void> showBigTextNotification(String title, String? body, String payload, String image, FlutterLocalNotificationsPlugin fln) async {
    ...
    if(!Get.find<AuthController>().isNotificationActive()){
      AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
        "khidmhWithoutsound","khidmh without sound", channelDescription:"description",
        playSound: false,
      ...
      AndroidNotificationDetails androidPlatformChannelSpecifics = AndroidNotificationDetails(
        "khidmh", 'khidmh with sound', channelDescription:"description",
        playSound: true,
