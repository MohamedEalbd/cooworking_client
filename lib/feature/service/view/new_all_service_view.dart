...
class NewAllServiceView extends StatefulWidget {
  final String?fromPage;
  final String? campaignID;
  const NewAllServiceView({super.key, this.fromPage, this.campaignID});

  @override
  State<NewAllServiceView> createState() => _NewAllServiceViewState();
}

class _NewAllServiceViewState extends State<NewAllServiceView> {
    ...
    return Scaffold(
      ...
      Column(
        children: [ 
          ...
          Expanded(child: _buildBody(widget.fromPage,context,scrollController)),
        ],
      )
          :
      FooterBaseView(
